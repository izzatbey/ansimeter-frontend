...
function LazadaDataTweet() {
  ...
  const handleClick = () => {
    navigate("/lazada-analyze-tweet");
  };

  const fetchData = async () => {
    const object = await getCrawlDataLazada();
    console.log(object);
    setData(object);
          ...
          <Grid container spacing={2} marginTop={4}>
            <Grid container>
              <Grid container xs={6} justifyContent="flex-start">
                <Typography>Data Tweet Lazada</Typography>
              </Grid>
...
export default LazadaDataTweet;
