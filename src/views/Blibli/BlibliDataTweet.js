...
function BlibliDataTweet() {
  ...
  const handleClick = () => {
    navigate("/blibli-analyze-tweet");
  };

  const fetchData = async () => {
    const object = await getCrawlDataBlibli();
    console.log(object);
    setData(object);
          ...
          <Grid container spacing={2} marginTop={4}>
            <Grid container>
              <Grid container xs={6} justifyContent="flex-start">
                <Typography>Data Tweet Blibli</Typography>
              </Grid>
...
export default BlibliDataTweet;
