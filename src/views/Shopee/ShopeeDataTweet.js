...
function ShopeeDataTweet() {
  ...
  const handleClick = () => {
    navigate("/shopee-analyze-tweet");
  };

  const fetchData = async () => {
    const object = await getCrawlDataShopee();
    console.log(object);
    setData(object);
          ...
          <Grid container spacing={2} marginTop={4}>
            <Grid container>
              <Grid container xs={6} justifyContent="flex-start">
                <Typography>Data Tweet Shopee</Typography>
              </Grid>
...
export default ShopeeDataTweet;
